...
| phase4 | level-free | -0.4618 [-0.5842, -0.3595] / sign 0.708 [0.688, 0.727] (ridge) | +0.3594 [+0.3282, +0.3859] / sign 0.812 [0.799, 0.826] (gbt) |
| phase4 | full field set | +0.2260 [+0.1621, +0.2816] / sign 0.824 [0.809, 0.838] (gbt) | +0.5435 [+0.5114, +0.5743] / sign 0.899 [0.887, 0.910] (gbt) |

## The brief's quantity

- calm-trained level-free R2(x): +0.3493 [+0.3218, +0.3743] -> +0.3594 [+0.3282, +0.3859], delta +0.0101 -- CIs OVERLAP: no detected change
- calm-trained full field set R2(x): +0.5501 [+0.5180, +0.5791] -> +0.5435 [+0.5114, +0.5743], delta -0.0066 -- CIs OVERLAP: no detected change
