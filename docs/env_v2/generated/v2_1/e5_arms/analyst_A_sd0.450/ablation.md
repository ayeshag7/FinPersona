...
|---|---|---|
| ANALYST | +0.0018 [-0.0017, +0.0051] | n/a |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] |
|---|---|---|
| ANALYST | +0.0175 [+0.0056, +0.0293] | n/a |
...
|---|---|---|---|
| ANALYST | +0.0318 [+0.0200, +0.0429] | n/a | 0.1377 -> 0.1345 |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] | MAPE(V) base -> +G |
|---|---|---|---|
| ANALYST | +0.0281 [+0.0121, +0.0421] | n/a | 0.1067 -> 0.1040 |
