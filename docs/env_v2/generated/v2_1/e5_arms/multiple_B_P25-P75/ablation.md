...
|---|---|---|---|
| VAL | +0.0103 [+0.0029, +0.0177] | n/a | 0.1377 -> 0.1365 |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] | MAPE(V) base -> +G |
|---|---|---|---|
| VAL | +0.0060 [-0.0043, +0.0172] | n/a | 0.1067 -> 0.1047 |
