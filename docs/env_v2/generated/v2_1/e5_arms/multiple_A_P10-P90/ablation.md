...
|---|---|---|---|
| VAL | +0.0178 [+0.0078, +0.0268] | n/a | 0.1377 -> 0.1368 |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] | MAPE(V) base -> +G |
|---|---|---|---|
| VAL | +0.0161 [+0.0024, +0.0293] | n/a | 0.1067 -> 0.1052 |
