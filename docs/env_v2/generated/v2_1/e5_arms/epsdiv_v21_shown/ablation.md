...
|---|---|---|---|
| VAL | +0.0980 [+0.0813, +0.1137] | n/a | 0.1377 -> 0.1277 |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] | MAPE(V) base -> +G |
|---|---|---|---|
| VAL | +0.0743 [+0.0572, +0.0912] | n/a | 0.1067 -> 0.1007 |
