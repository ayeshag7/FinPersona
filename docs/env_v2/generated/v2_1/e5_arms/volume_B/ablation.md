...
|---|---|---|---|
| VOL | +0.0051 [+0.0034, +0.0069] | n/a | 0.1377 -> 0.1370 |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] | MAPE(V) base -> +G |
|---|---|---|---|
| VOL | +0.0026 [+0.0006, +0.0049] | n/a | 0.1067 -> 0.1064 |
