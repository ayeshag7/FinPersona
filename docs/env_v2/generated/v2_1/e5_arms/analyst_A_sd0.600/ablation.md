...
|---|---|---|
| ANALYST | +0.0017 [-0.0016, +0.0050] | n/a |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] |
|---|---|---|
| ANALYST | +0.0126 [+0.0006, +0.0249] | n/a |
...
|---|---|---|---|
| ANALYST | +0.0257 [+0.0148, +0.0355] | n/a | 0.1377 -> 0.1353 |
...
| group | add-one delta [paired CI] | drop-one delta [paired CI] | MAPE(V) base -> +G |
|---|---|---|---|
| ANALYST | +0.0217 [+0.0068, +0.0342] | n/a | 0.1067 -> 0.1046 |
