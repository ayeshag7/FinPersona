# E5.7(c) onset-detection audit -- analyst_A_sd0.450

200 crash + 200 bull-trap seeds, schedule pinned v21, overrides {"multiple": {"design": "v2"}, "eps": {"design": "v2"}, "dividend": {"design": "v2"}, "analyst": {"design": "A", "sd": 0.45, "rho": 0.95, "update_days": 5, "field": "shown", "lit_anchor_sd": 0.5639913617919751, "bracket_phase9": [0.3, 0.45, 0.6]}, "sentiment": {"design": "v2"}, "volume": {"design": "v2"}}; 500 circular-shift null draws. Rule: dAUC (field - best price-derived reference) <= null p95.
...
|---|---|---|---|---|---|
| analyst_fair_value | 0.597 | +0.0177 | +0.0011 | **NO** | -1 [-5.0, 5.0] |
...
| analyst_fair_value | 0.623 | -0.1106 | +0.0058 | yes | +0 [-5.0, 4.25] |
...
| analyst_fair_value | 0.512 | -0.1427 | +0.0090 | yes | +0 [-5.0, 4.25] |
...
| analyst_fair_value | 0.502 | +0.0004 | +0.0051 | yes | +0 [-6.0, 5.0] |
...
| analyst_fair_value | 0.514 | -0.0223 | +0.0070 | yes | +0 [-5.0, 5.25] |
...
| analyst_fair_value | 0.529 | -0.0540 | +0.0231 | yes | -2 [-6.0, 6.0] |
