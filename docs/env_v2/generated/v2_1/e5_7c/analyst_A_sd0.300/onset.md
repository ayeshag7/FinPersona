# E5.7(c) onset-detection audit -- analyst_A_sd0.300

200 crash + 200 bull-trap seeds, schedule pinned v21, overrides {"multiple": {"design": "v2"}, "eps": {"design": "v2"}, "dividend": {"design": "v2"}, "analyst": {"design": "A", "sd": 0.3, "rho": 0.95, "update_days": 5, "field": "shown", "lit_anchor_sd": 0.5639913617919751, "bracket_phase9": [0.3, 0.45, 0.6]}, "sentiment": {"design": "v2"}, "volume": {"design": "v2"}}; 500 circular-shift null draws. Rule: dAUC (field - best price-derived reference) <= null p95.
...
|---|---|---|---|---|---|
| analyst_fair_value | 0.600 | +0.0209 | +0.0008 | **NO** | +1 [-4.25, 5.0] |
...
| analyst_fair_value | 0.630 | -0.1041 | +0.0058 | yes | +0 [-5.0, 4.0] |
...
| analyst_fair_value | 0.513 | -0.1422 | +0.0081 | yes | +0 [-5.0, 4.25] |
...
| analyst_fair_value | 0.502 | +0.0006 | +0.0048 | yes | +0 [-6.0, 5.0] |
...
| analyst_fair_value | 0.513 | -0.0235 | +0.0072 | yes | +0 [-5.25, 5.0] |
...
| analyst_fair_value | 0.528 | -0.0545 | +0.0248 | yes | -0 [-6.0, 7.5] |
