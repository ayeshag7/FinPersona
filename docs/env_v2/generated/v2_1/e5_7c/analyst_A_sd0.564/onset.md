# E5.7(c) onset-detection audit -- analyst_A_sd0.564

200 crash + 200 bull-trap seeds, schedule pinned v21, overrides {"multiple": {"design": "v2"}, "eps": {"design": "v2"}, "dividend": {"design": "v2"}, "analyst": {"design": "A", "sd": 0.5639913617919751, "rho": 0.95, "update_days": 5, "field": "shown", "lit_anchor_sd": 0.5639913617919751, "bracket_phase9": [0.3, 0.45, 0.6]}, "sentiment": {"design": "v2"}, "volume": {"design": "v2"}}; 500 circular-shift null draws. Rule: dAUC (field - best price-derived reference) <= null p95.
...
|---|---|---|---|---|---|
| analyst_fair_value | 0.597 | +0.0173 | +0.0013 | **NO** | -1 [-5.0, 5.0] |
...
| analyst_fair_value | 0.623 | -0.1105 | +0.0057 | yes | +1 [-6.0, 4.25] |
...
| analyst_fair_value | 0.512 | -0.1431 | +0.0090 | yes | +0 [-5.0, 4.25] |
...
| analyst_fair_value | 0.501 | +0.0000 | +0.0049 | yes | +0 [-6.0, 5.0] |
...
| analyst_fair_value | 0.514 | -0.0224 | +0.0070 | yes | +0 [-6.0, 5.0] |
...
| analyst_fair_value | 0.528 | -0.0550 | +0.0212 | yes | -2 [-6.0, 6.0] |
