# E5.7(c) onset-detection audit -- volume_B

200 crash + 200 bull-trap seeds, schedule pinned v21, overrides {"multiple": {"design": "v2"}, "eps": {"design": "v2"}, "dividend": {"design": "v2"}, "analyst": {"design": "v2"}, "sentiment": {"design": "v2"}, "volume": {"design": "B", "rho_v": 0.525916765977577, "beta_absr": 0.2026552181805277, "sd_e": 0.34686231428914344, "beta_ru": -0.012314957617872479}}; 500 circular-shift null draws. Rule: dAUC (field - best price-derived reference) <= null p95.
...
| volume_ratio | 0.538 | -0.0416 | +0.0072 | yes | +4 [-1.0, 7.25] |
| implied_volatility | 0.536 | -0.0434 | +0.0072 | yes | +2 [-1.0, 6.0] |
| volume | 0.509 | -0.0705 | +0.0097 | yes | +2 [-3.0, 6.0] |
...
| volume | 0.521 | -0.1338 | +0.0100 | yes | -2 [-6.0, 3.0] |
...
| volume_ratio | 0.483 | -0.1717 | +0.0128 | yes | -3 [-8.0, 1.0] |
...
| volume_ratio | 0.485 | -0.0168 | +0.0106 | yes | +0 [-5.0, 5.0] |
| reported_PE | 0.484 | -0.0175 | +0.0008 | yes | +1 [-4.0, 5.0] |
| volume | 0.482 | -0.0192 | +0.0085 | yes | -2 [-6.0, 4.0] |
...
| volume_ratio | 0.511 | -0.0252 | +0.0092 | yes | +1 [-5.0, 6.0] |
| trend_strength | 0.509 | -0.0268 | +0.0161 | yes | -1 [-7.0, 6.0] |
| volume | 0.509 | -0.0271 | +0.0096 | yes | -1 [-6.0, 5.0] |
...
| volume | 0.490 | -0.0932 | +0.0240 | yes | -2 [-6.75, 1.0] |
| volume_ratio | 0.463 | -0.1198 | +0.0278 | yes | -4 [-8.75, 1.0] |
