# E5.7(c) onset-detection audit -- volume_A

200 crash + 200 bull-trap seeds, schedule pinned v21, overrides {"multiple": {"design": "v2"}, "eps": {"design": "v2"}, "dividend": {"design": "v2"}, "analyst": {"design": "v2"}, "sentiment": {"design": "v2"}, "volume": {"design": "A", "rho_v": 0.525916765977577, "beta_absr": 0.2026552181805277, "sd_e": 0.34686231428914344, "beta_ru": -0.012314957617872479}}; 500 circular-shift null draws. Rule: dAUC (field - best price-derived reference) <= null p95.
...
| volume_ratio | 0.538 | -0.0418 | +0.0073 | yes | +4 [-1.0, 7.25] |
...
| volume_ratio | 0.608 | -0.1258 | +0.0076 | yes | +3 [-1.0, 6.0] |
...
| volume_ratio | 0.483 | -0.1718 | +0.0127 | yes | -3 [-8.0, 1.0] |
...
| volume_ratio | 0.484 | -0.0168 | +0.0103 | yes | +0 [-5.0, 5.0] |
...
| volume_ratio | 0.511 | -0.0248 | +0.0091 | yes | +2 [-5.0, 6.0] |
...
| volume | 0.490 | -0.0933 | +0.0240 | yes | -2 [-6.75, 1.0] |
| volume_ratio | 0.464 | -0.1191 | +0.0279 | yes | -4 [-8.75, 1.0] |
